...
for pair, max_time in zip(list_of_pairs, list_of_max_times):
    waitTime_list = np.arange(0, max_time+100, max_time/10)
    ...
    #--------------------------------------------------------Raw_data_file_saving-----------------------------------------------------------------------------------------------
                    ...
                    filename = f'Z:\\Lab Data\\Qudit_Ramsey_raw_data\\Bussed_ramsey_detuning_calibration_data\\\Ramsey_experiment_{pulse_train_U1[:-1]}_{np.round(wtr)}_us_{num_repeat}_{dt_string}.txt'
